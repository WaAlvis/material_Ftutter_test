...
import 'package:localdaily/services/users_service.dart';
...
class LdLocator {
  ...
  static Future<void> setUpLocator() async {
    ...
    locator.registerSingleton<WebAdminService>(WebAdminService(dio));
    locator.registerSingleton<UsersService>(UsersService(dio));
