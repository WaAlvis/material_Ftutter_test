...
class HistoryMobile extends StatelessWidget {
  ...
  Padding dateHeader(TextTheme textTheme,
      String date,) {
    return Padding(
...
class ListOperationDay extends StatelessWidget {
  const ListOperationDay(this.viewModel,
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return Padding(
          ...
          Material(
            ...
            child: InkWell(
              onTap: () =>
                  viewModel.goDetailHistoryOperation(context,
              ...
              children: <Widget>[
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(
                      '${dayOperations[index].advertisement
                          .margin} DLYCOP ≈ 1 COP',
                      style: textTheme.textGray.copyWith(
                        fontSize: 12,
                      ),
